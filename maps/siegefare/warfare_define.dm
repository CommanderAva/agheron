...
/datum/map/warfare
	...
	lobby_icon = 'maps/siegefare/fullscreen.dmi'
	...
	base_turf_by_z = list("1" = /turf/simulated/floor/asteroid/, "2" = /turf/simulated/floor/dirty, "3" = /turf/simulated/floor/dirty)
	...
	map_lore = "BLUE - MAIN OBJECTIVE: DEFEND THE MACHINE. SECONDARY OBJECTIVE: SURVIVE.	RED - MAIN OBJECTIVE: CAPTURE THE MACHINE. SECONDARY OBJECTIVE: DIE TRYING."
